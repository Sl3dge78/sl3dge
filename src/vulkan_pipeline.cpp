...
inline VkPipelineRasterizationStateCreateInfo GetDefaultRasterizationState() {
...
inline VkPipelineColorBlendStateCreateInfo GetDefaultColorBlendState(
		const u32 attachement_cout, const VkPipelineColorBlendAttachmentState *attachements) {
