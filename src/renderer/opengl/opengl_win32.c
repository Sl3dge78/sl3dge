...
void GLLoadFunctions() {
    ...
    LOAD_GL_FUNC(PFNGLCREATESHADERPROGRAMVPROC, glCreateShaderProgramv);
    LOAD_GL_FUNC(PFNGLGENPROGRAMPIPELINESPROC, glGenProgramPipelines);
    LOAD_GL_FUNC(PFNGLBINDPROGRAMPIPELINEPROC, glBindProgramPipeline);
    LOAD_GL_FUNC(PFNGLUSEPROGRAMSTAGESPROC, glUseProgramStages);
    LOAD_GL_FUNC(PFNGLDELETEPROGRAMPIPELINESPROC, glDeleteProgramPipelines);
    
    LOAD_GL_FUNC(PFNGLPROGRAMUNIFORMMATRIX4FVPROC, glProgramUniformMatrix4fv);
    LOAD_GL_FUNC(PFNGLPROGRAMUNIFORM1IPROC, glProgramUniform1i);
    LOAD_GL_FUNC(PFNGLPROGRAMUNIFORM3FPROC, glProgramUniform3f);
