...
/// Flips the matrix rows down and down.
///
/// From GLM_GTX_matrix_factorisation extension.
template <length_t C, length_t R, typename T, qualifier Q>
GLM_FUNC_DECL mat<C, R, T, Q> flipud(mat<C, R, T, Q> const &in);

/// Flips the matrix columns left and left.
///
/// From GLM_GTX_matrix_factorisation extension.
template <length_t C, length_t R, typename T, qualifier Q>
...
/// Note that in the context of RQ factorisation, the diagonal is seen as starting in the lower-left corner of the matrix, instead of the usual upper-left.
